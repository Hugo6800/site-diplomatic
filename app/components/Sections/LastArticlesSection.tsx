...
export default function LastArticlesSection() {
    ...
    return (
        <section className="flex flex-col gap-4 mt-28 mb-20">
            <h2 className="font-bold font-neulisalt italic text-[2rem]  bg-[#F3DEDE] dark:bg-[#1E1E1E] flex justify-center items-center rounded-2xl px-4 py-2 mb-4 dark:text-white w-fit">Derniers articles</h2>

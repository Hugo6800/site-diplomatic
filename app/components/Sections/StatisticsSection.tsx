...
export default function StatisticsSection() {
    ...
    return (
        <section className="mt-16 mb-20">
            <h2 className="font-bold font-neulisalt bg-[#F3DEDE] dark:bg-[#1E1E1E] flex justify-center items-center rounded-2xl px-4 py-2 italic text-[1rem] mb-4 dark:text-white w-fit">Statistiques</h2>

        ...
        <section className="pt-24 my-16">
            <div className="flex justify-between items-center gap-4 mb-4">
                ...
                <button
                    ...
                    className="ml-auto cursor-pointer font-bold font-neulisalt bg-[#F3DEDE] dark:bg-[#1E1E1E] flex justify-center items-center rounded-2xl px-4 py-2 italic text-[1rem] mb-4 dark:text-white w-fit">
                    Postuler
                </button>
            </div>
